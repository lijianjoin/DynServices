...
class TestRemoteServicePropertyResolver {
    ...
    private MockedStatic<SpringContextUtils> providerMockedStatic;
    ...
    void setUp() {
        ...
        providerMockedStatic = mockStatic(SpringContextUtils.class);
        providerMockedStatic.when(SpringContextUtils::getContext).thenReturn(applicationContext);
